...
// Force mongoose to use strict mode and ensure all fields are saved
restaurantSchema.set('strict', false); // Allow additional fields temporarily
...
app.post("/api/notifications", async (req, res) => {
  try {
    ...
    await fetch("https://api.onesignal.com/notifications?c=push", {
      method: "POST", 
      headers: {
        "Authorization": `os_v2_app_zsuwh276nnayfkjdp6ihbvdme5gqm4qdsituwxnbhehpy7koonmh4qzxi2btgqcikmwu3xbn7l6mxlmgsuetgl6wb46iyyhdivevoii`,
